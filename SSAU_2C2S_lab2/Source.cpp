...
int main()
{
	...
	std::cout << "„исло сравнений и копирований при неотсортированном массиве:" << std::endl;
	...
	std::cout << "ƒемонстраци€ сортировки пузырьком. Ѕыло:" << std::endl;
	for (int i = 0; i < 10; ++i)
	{
	...
	std::cout << std::endl <<  "—тало:" << std::endl;
	BubbleSort(vec);
	for (auto it : vec)
	{
		std::cout << it << " ";
	...
	std::cout << std::endl << std::endl << "ƒемонстраци€ сортировки Ўелла. Ѕыло:" << std::endl;
	for (int i = 0; i < 10; ++i)
	{
		vec.push_back((double)rand() / 5 - 312);
	}
	...
	std::cout << std::endl << std::endl << "ƒемонстраци€ сортировки кучей. Ѕыло:" << std::endl;
	for (int i = 0; i < 10; ++i)
	{
		vec.push_back((double)rand() / 5 - 312);
	}
